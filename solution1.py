...
# todo: get them unstuck, Give them hints via, "What if you did this?"

# todo: Encourage them to - Talk through the problem, Don't give up, Ask about edge cases

# todo: If they're thinking list, let them explore it (spoiler alert: it won't be pretty)

# todo: If they struggle to make a dictionary, that's not uncommon at this point, and this is great practice for them.

# todo: Walk them through the key/value structure


# I USED DICTIONARY TO SIMPLIFY SELECTION OF LANGUAGE
greeting_lang = {
    "e_greet": "Hello!",
...
# I USED VARS ASSIGNED TO SELECT DICT. ITEMS EASILY
e = greeting_lang['e_greet']
s = greeting_lang['s_greet']
f = greeting_lang['f_greet']

# originally CHOSE NUMBERS AS A TEMPORARY BRUTEFORCE RESPONSE FOR AVOIDING ANY POSSIBLE CAPS PROBLEMS
